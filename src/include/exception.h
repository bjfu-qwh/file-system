...
class Exception : public std::runtime_error {
   public:
    ...
    explicit Exception(const ExceptionType type, const std::string &msg,
...
class FileNotFoundException : public Exception {
   public:
    ...
    explicit FileNotFoundException(const std::string &msg)
        : Exception(ExceptionType::FILE_NOT_FOUND, msg) {}
};
...
class SystemExpection : public Exception {
   public:
    ...
    explicit SystemExpection(const std::string &msg)
        : Exception(ExceptionType::SYSTEM_ERROR, msg) {}
};
...
class OutOfRangeException : public Exception {
   public:
    ...
    explicit OutOfRangeException(const std::string &msg)
        : Exception(ExceptionType::OUT_OUT_RANGE, msg) {}
};
}  // namespace FileSystem
#endif  // EXCEPTION_H
